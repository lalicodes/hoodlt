"""
:module: hex_2d_lat_Mixt
:platform: Unix, Windows
:synopsis: Defines the class implementing the hexagonal lattice
...
class LatHexagonal(LatSimple):
    ...
    def __init__(self, l_value, a_nn_e):
        ...
        super(LatHexagonal, self).__init__(l_value, a_nn_e)
