...
:synopsis: Defines the class for TO4032 (Au4032S)
...
class TO4032(CoreWithPositionsInFile):
    """
    Defines a truncated octahedron with 4032 core particles on the shell, and 1082 grafting sites cut from the 1-1-1 and
    0-0-1 planes of an FCC lattice. This class only uses about 1000 particles and 432 grafting sites, not the full number
    """

    num_core_particles = 1082
    ...
    def __init__(self, ff, core_types=['Au'], scale=1, name_rigid_center=None):
        ...
        super(TO4032, self).__init__(ff, self.num_core_particles, "TO4032.txt", core_types, scale, name_rigid_center, 4032)
    ...
    def get_vector(self):
        ...
        return self.position[567] - self.position[0]  # points along z-axis
