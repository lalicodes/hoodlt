...
class PEO(SolventAbs):
    ...
    def __init__(self, repeats, ff):
        ...
        super(PEO, self).__init__(repeats, ff, repeats*self.repeat_length+2, 'PEO')
        ...
        self.types = ['C2', 'C3', 'HP', 'OP']
        self.end_group = 2 * [None]
        self.end_group[0] = ['HP', 'HP', 'HP', 'C3', 'OP', 'C2', 'HP', 'HP']
        self.end_group[1] = self.end_group[0][::-1]
        if repeats == 1:
            self.typeid = ['HP', 'HP', 'HP', 'C3', 'OP', 'C3', 'HP', 'HP', 'HP']
        else:
    ...
    def get_angles(self):
        ...
        a_list = [[0, 3, 1], [0, 3, 2], [1, 3, 2], [4, 3, 0], [4, 3, 1], [4, 3, 2], [3, 4, 5]]
        if self.repeats == 1:
    ...
    def get_angle_types(self):
        ...
        a_types = 3*['HP-C3-HP'] + 3*['OP-C3-HP'] + ['C3-OP-C2']
        if self.repeats == 1:
    ...
    def get_dihedrals(self):
        ...
        if self.repeats == 1:
            d_list = [[5, 4, 3, 2], [5, 4, 3, 1], [5, 4, 3, 0], [3, 4, 5, 6], [3, 4, 5, 7], [3, 4, 5, 8]]
        else:
            d_list = [[5, 4, 3, 2], [5, 4, 3, 1], [5, 4, 3, 0], [3, 4, 5, 6], [3, 4, 5, 7]]
            d_list += [[3, 4, 5, 10]] # [c3-o-c2-c2]
            d_num = 5
    ...
    def get_dihedral_types(self):
        ...
        d_types = []
        if self.repeats == 1:
            d_types += 6*['C3-OP-C3-HP']
        else:
            d_types += 3*['C2-OP-C3-HP'] + 2*['C3-OP-C2-HP'] + ['C3-OP-C2-C2']
